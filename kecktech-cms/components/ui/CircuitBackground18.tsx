...
const CircuitBackground18: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initCircuit = () => {
      ...
      const baseStraightLength = Math.min(width, height) * 0.10;
      const turnLength = Math.min(width, height) * 0.11;
      
      // Top side - varied lengths, ensure different directions
      const topStraightLengths = [baseStraightLength * 0.65, baseStraightLength * 1.35, baseStraightLength];
      const topTurnDirs: ('left' | 'right')[] = ['left', 'right', 'left'];
      ...
      // Right side - varied lengths, ensure different directions
      const rightStraightLengths = [baseStraightLength * 1.25, baseStraightLength * 0.75, baseStraightLength * 1.1];
      const rightTurnDirs: ('left' | 'right')[] = ['left', 'right', 'left'];
      ...
      // Bottom side - varied lengths, ensure different directions
      const bottomStraightLengths = [baseStraightLength * 0.9, baseStraightLength * 1.4, baseStraightLength * 0.7];
      const bottomTurnDirs: ('left' | 'right')[] = ['right', 'left', 'right'];
      ...
      // Left side - varied lengths, ensure different directions
      const leftStraightLengths = [baseStraightLength * 1.15, baseStraightLength, baseStraightLength * 1.3];
      const leftTurnDirs: ('left' | 'right')[] = ['right', 'left', 'right'];
    ...
    const drawCircuit = () => {
      ...
      balls.forEach((ball) => {
        ...
        if (ball.progress >= 1) {
          ...
          ball.progress = 0;
          ball.direction = 1;
          ball.speed = 0.005 + Math.random() * 0.007;
        }
...
export default CircuitBackground18;
