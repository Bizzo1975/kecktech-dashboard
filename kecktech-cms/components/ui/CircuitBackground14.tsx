...
const CircuitBackground14: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initCircuit = () => {
      ...
      const straightLength = Math.min(width, height) * 0.18;
      const turnLength = Math.min(width, height) * 0.15;
...
export default CircuitBackground14;
