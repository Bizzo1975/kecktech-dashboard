...
const CircuitBackground17: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initCircuit = () => {
      ...
      const baseStraightLength = Math.min(width, height) * 0.14;
      const turnLength = Math.min(width, height) * 0.13;
      
      // Top side - varied lengths, mixed directions
      const topStraightLengths = [baseStraightLength * 0.6, baseStraightLength * 1.4, baseStraightLength * 0.9];
      const topTurnDirs: ('left' | 'right')[] = ['right', 'left', 'right'];
      ...
      // Right side - varied lengths, mixed directions
      const rightStraightLengths = [baseStraightLength * 1.3, baseStraightLength * 0.7, baseStraightLength * 1.1];
      const rightTurnDirs: ('left' | 'right')[] = ['right', 'left', 'right'];
      ...
      // Bottom side - varied lengths, mixed directions
      const bottomStraightLengths = [baseStraightLength * 0.8, baseStraightLength * 1.5, baseStraightLength];
      const bottomTurnDirs: ('left' | 'right')[] = ['left', 'right', 'left'];
      ...
      // Left side - varied lengths, mixed directions
      const leftStraightLengths = [baseStraightLength * 1.2, baseStraightLength * 0.9, baseStraightLength * 1.3];
      const leftTurnDirs: ('left' | 'right')[] = ['left', 'right', 'left'];
...
export default CircuitBackground17;
