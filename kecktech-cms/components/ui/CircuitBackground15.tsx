...
const CircuitBackground15: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initCircuit = () => {
      ...
      const straightLength = Math.min(width, height) * 0.12;
      const turnLength = Math.min(width, height) * 0.10;
...
export default CircuitBackground15;
