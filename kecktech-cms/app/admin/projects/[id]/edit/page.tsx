  ...
  useEffect(() => {
    const fetchProject = async () => {
      try {
        ...
        setValue("sourceCode", project.sourceCode || "");
        setValue("contactEmail", project.contactEmail || "");
        setValue("technologies", joinStringArray(project.technologies));
        setValue("featured", project.featured);
        setValue("available", project.available);
  ...
  const onSubmit = async (data: ProjectFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "The project has been updated and demos sync attempted.",
      });
      router.push("/admin/projects");
    } catch (error: unknown) {
      toast({
