            ...
            <div className="w-full relative" style={{ minHeight: '200px', position: 'relative' }}>
              <ScrollReveal>
                <div className="relative">
                  ...
                  <div className="flex flex-col" style={{ position: 'absolute', left: '0px', top: '-100px', minHeight: '368px' }}>
                  ...
                  <div className="text-right" style={{ paddingTop: '25px', position: 'relative' }}>
            ...
            <div className="w-full max-w-7xl bg-transparent">
              <ScrollReveal>
                <div className="mb-16 text-left bg-transparent" style={{ position: 'relative', marginLeft: '35px' }}>
                  ...
                  <p className="text-xl text-white/95 drop-shadow-[0_0_10px_rgba(0,0,0,0.8)]" style={{ marginBottom: '25px' }}>
